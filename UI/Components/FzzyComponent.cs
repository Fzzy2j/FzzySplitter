    ...
    class FzzyComponent : LogicComponent
    {
        ...
        public FzzyComponent(LiveSplitState state)
        {
            ...
            aslSettings.AddSetting("bnrHelmetSplit", true, "Blood & Rust", "helmetSplit");
                aslSettings.AddSetting("bnrHelmet1", true, "Helmet 1", "bnrHelmetSplit");
                aslSettings.AddSetting("bnrHelmet2", true, "Helmet 2", "bnrHelmetSplit");
                aslSettings.AddSetting("bnrHelmet3", true, "Helmet 3", "bnrHelmetSplit");
                aslSettings.AddSetting("bnrHelmet4", true, "Helmet 4", "bnrHelmetSplit");
                aslSettings.AddSetting("bnrHelmet5", true, "Helmet 5", "bnrHelmetSplit");
                aslSettings.AddSetting("bnrHelmet6", true, "Helmet 6", "bnrHelmetSplit");

            aslSettings.AddSetting("ita1HelmetSplit", true, "Into the Abyss 1", "helmetSplit");
                aslSettings.AddSetting("ita1Helmet1", true, "Helmet 1", "ita1HelmetSplit");
                aslSettings.AddSetting("ita1Helmet2", true, "Helmet 2", "ita1HelmetSplit");
            ...
            aslSettings.AddSetting("enc1HelmetSplit", false, "Effect & Cause 1", "helmetSplit");
                aslSettings.AddSetting("enc1Helmet1", false, "Helmet 1", "enc1HelmetSplit");
                aslSettings.AddSetting("enc1Helmet2", false, "Helmet 2", "enc1HelmetSplit");

            aslSettings.AddSetting("enc2HelmetSplit", true, "Effect & Cause 2", "helmetSplit");
                aslSettings.AddSetting("enc2Helmet1", true, "Helmet 1", "enc2HelmetSplit");
                aslSettings.AddSetting("enc2Helmet2", true, "Helmet 2", "enc2HelmetSplit");
                aslSettings.AddSetting("enc2Helmet3", true, "Helmet 3", "enc2HelmetSplit");
                aslSettings.AddSetting("enc2Helmet4", true, "Helmet 4", "enc2HelmetSplit");
                aslSettings.AddSetting("enc2Helmet5", true, "Helmet 5", "enc2HelmetSplit");
            ...
            aslSettings.AddSetting("b1HelmetSplit", false, "The Beacon 1", "helmetSplit");
            aslSettings.AddSetting("b2HelmetSplit", true, "The Beacon 2", "helmetSplit");
                aslSettings.AddSetting("b2Helmet1", true, "Helmet 1", "b2HelmetSplit");
                aslSettings.AddSetting("b2Helmet2", true, "Helmet 3", "b2HelmetSplit");

            aslSettings.AddSetting("b3HelmetSplit", true, "The Beacon 3", "helmetSplit");
                aslSettings.AddSetting("b3Helmet1", true, "Helmet 1", "b3HelmetSplit");
                aslSettings.AddSetting("b3Helmet2", true, "Helmet 2", "b3HelmetSplit");
                aslSettings.AddSetting("b3Helmet3", true, "Helmet 3", "b3HelmetSplit");
                aslSettings.AddSetting("b3Helmet4", true, "Helmet 4", "b3HelmetSplit");
                aslSettings.AddSetting("b3Helmet5", true, "Helmet 5", "b3HelmetSplit");
                aslSettings.AddSetting("b3Helmet6", true, "Helmet 6", "b3HelmetSplit");
                aslSettings.AddSetting("b3Helmet7", true, "Helmet 7", "b3HelmetSplit");
                aslSettings.AddSetting("b3Helmet8", true, "Helmet 8", "b3HelmetSplit");
                aslSettings.AddSetting("b3Helmet9", true, "Helmet 9", "b3HelmetSplit");

            aslSettings.AddSetting("tbfHelmetSplit", true, "Trial by Fire", "helmetSplit");
                aslSettings.AddSetting("tbfHelmet1", true, "Helmet 1", "tbfHelmetSplit");
                aslSettings.AddSetting("tbfHelmet2", true, "Helmet 2", "tbfHelmetSplit");
                aslSettings.AddSetting("tbfHelmet3", true, "Helmet 3", "tbfHelmetSplit");

            aslSettings.AddSetting("arkHelmetSplit", true, "The Ark", "helmetSplit");
                aslSettings.AddSetting("arkHelmet1", true, "Helmet 1", "arkHelmetSplit");
                aslSettings.AddSetting("arkHelmet2", true, "Helmet 2", "arkHelmetSplit");
                aslSettings.AddSetting("arkHelmet3", true, "Helmet 3", "arkHelmetSplit");

            aslSettings.AddSetting("foldHelmetSplit", true, "The Fold Weapon", "helmetSplit");
                aslSettings.AddSetting("foldHelmet1", true, "Helmet 1", "foldHelmetSplit");
                aslSettings.AddSetting("foldHelmet2", true, "Helmet 2", "foldHelmetSplit");
                aslSettings.AddSetting("foldHelmet3", true, "Helmet 3", "foldHelmetSplit");
